  ...
  return (
    <div className="w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b] p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center">
      ...
      <div className="flex  flex-col gap-4">
        <h3 className="text-3xl font-bold text-white">Khushal Borse</h3>
        <p className="text-lg font-normal text-gray-400">Web Developer & Android Developer</p>
        <p className="text-base text-gray-400 tracking-wide">
          If have any thing to say, please free to contact me.
        </p>
        <p className="text-base text-gray-400 flex items-center gap-2">
          Email:{" "}
          <span className=" text-lightText">borsekhushal37@gmail.com</span>
        </p>
      </div>
